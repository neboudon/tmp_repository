# ファイル名: debug_pi4_serial_usb.py

import serial
import time

# ★★★ここが最重要★★★
# Pi 4とPicoをUSBケーブルで接続する場合、
# ポート名は '/dev/ttyACM0' (または /dev/ttyACM1) になります。
...
try:
    ...
    while True:
        ...
        message_to_send = "PING_FROM_PI_USB\n" # 改行コード(\n)が重要
    ...
    print("PicoがUSBで正しく接続されているか確認してください。")
    print("権限エラーの場合: 'sudo usermod -aG dialout $USER' (要再起動) を試してください。")
